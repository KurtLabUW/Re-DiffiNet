import numpy as np
from brats_data_utils_multi_label import get_loader_brats
import torch 
...
#data_dir = '/gscratch/kurtlab/brats2023/data/brats-gli/diff_cv_final/fold1'

logdir = "/gscratch/kurtlab/diffusion_test/log/diffusion_seg_oct30_test/"
...
class DiffUNet(nn.Module):
    ...
    def forward(self, image=None, x=None, pred_type=None, step=None):
        if pred_type == "q_sample":
            ...
            sample_out = self.sample_diffusion.ddim_sample_loop(self.model, (1, number_targets, 128,192,128), model_kwargs={"image": image, "embeddings": embeddings})
